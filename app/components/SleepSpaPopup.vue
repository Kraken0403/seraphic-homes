      ...
      >
        ...
        >
          ...
          <p class="text-center text-[14px] opacity-80 mb-6 leading-[1.5]">
            Experience personalised sleep consultation and discover the science
            behind perfect rest.
          </p>
          ...
          <div v-if="status === 'success'" class="text-center">
            <p class="text-[16px] text-green-600">
              Thank you! We’ll connect with you shortly to confirm your session.
            </p>
          </div>
          ...
          >
            ...
            <button type="submit" class="btn-pill mt-4">
              <div class="btn-inner">
                <div class="btn-flex">
                  <div class="btn-text top">Book Sleep Spa</div>
                  <div class="btn-text bottom">Book Sleep Spa</div>
                </div>
              </div>
            </button>
          </form>
